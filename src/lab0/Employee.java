...
public class Employee {
    ...
    public final void setDaysVacation(int daysVacation) {
        if(daysVacation > maxDaysVacation || daysVacation < 0){
            throw new IllegalArgumentException("Vacation must be between 0 and " + maxDaysVacation);
        }
    ...
    public int getMaxDaysVacation() {
        return maxDaysVacation;
    }

    public void setMaxDaysVacation(int maxDaysVacation) {
        this.maxDaysVacation = maxDaysVacation;
    }
